export type CommandType = 'MOUSE_MOVE_RELATIVE' | 'MOUSE_MOVE_ABSOLUTE' | 'MOUSE_CLICK' | 'MOUSE_DOUBLE_CLICK' | 'MOUSE_RIGHT_CLICK' | 'KEYBOARD_TYPE';
...
export type Command = MouseMoveRelativeCommand | MouseMoveAbsoluteCommand | MouseClickCommand | KeyboardTypeCommand;
